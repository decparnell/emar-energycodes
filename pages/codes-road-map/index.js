      ...
      <div className={styles.container}>
        <table className={styles.tableCRM}>
          <tbody>
            <tr>
              <td>
                <b>The REC Code Roadmap</b><br></br>
                <p>The REC Code Roadmap provides a view of the key areas of strategic change that RECCo and the REC Code Manager will focus on over the next three years.  These are areas of the REC where significant benefit could be gained for all REC stakeholders including consumers, within the long-term energy retail landscape.</p>
                <p>The ‘epics’ are the work items that will deliver the change.  The roadmap presents the epics that are active now and those that are due to be initiated in the coming months, so you can see what may be of interest to you and how you can get involved in shaping the solutions.</p>
              </td>
            </tr>
            <tr>
              <td>{latestCodesRoadMapLinkJSON.map(item => <a href={"https://" + item.link} target="_blank">Spreadsheet to download containing the roadmap</a>)}</td>
            </tr>
            <tr>
              <td>
